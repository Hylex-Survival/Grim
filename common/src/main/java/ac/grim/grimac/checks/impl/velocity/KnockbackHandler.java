    ...
    public void onPredictionComplete(final PredictionComplete predictionComplete) {
        ...
        if (player.likelyKB != null) {
            if (player.likelyKB.offset > offsetToFlag) {
                ...
                } else if (flagAndAlert(player.likelyKB.offset == Integer.MAX_VALUE ? "reason=ignored knockback"
                        : "offset=" + formatOffset(player.likelyKB.offset))) { // This velocity was sent by the server.
